...
export const metadata: Metadata = {
  title: 'NeuroCourt — AI Tennis Lab',
  description:
    'Two neural-network tennis brains play, scout, predict, and evolve against each other. Train models, run tournaments, and debug every decision.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
